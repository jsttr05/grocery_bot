...
WS_URL = "wss://game.ainm.no/ws?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..dQwdfqPSQdErmi9j0lNRsTSpghLHmQbH4H-kzr45q9g"
...
async def play():
    async with websockets.connect(WS_URL) as ws:
        ...
        while True:
            ...
            # Stuck detection: same position for 2+ consecutive rounds
            stuck_bots = {b["id"] for b in state["bots"]
                          if prev_positions.get(b["id"]) == tuple(b["position"])
                          and prev_prev_positions.get(b["id"]) == tuple(b["position"])}
